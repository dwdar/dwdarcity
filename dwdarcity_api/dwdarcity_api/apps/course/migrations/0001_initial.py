# Generated by Django 3.2 on 2022-04-07 09:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(null=True, upload_to='teacher', verbose_name='讲师头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_show_list', models.BooleanField(default=False, verbose_name='是否推荐到课程列表中显示')),
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_lesson', to='course.course', verbose_name='关联课程')),
            ],
            options={
                'verbose_name': '课程课时',
