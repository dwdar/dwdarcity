...
DATABASES = {
    ...
    # 开发环境需要使用mysql可以使用一下配置（配套测试数据库文件在项目根目录docs/dwdarcity.sql中)
    'default': {
...
ALIPAY_CONFIG = {
    ...
    "sign_type": "RSA2",
    "debug": False,
    "return_url": "http://192.168.31.134:8080/payments/alipay/result",  # 同步回调地址
    "notify_url": "http://192.168.31.134:8000/payments/alipay/result",  # 支付宝异步结果通知
}
